    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="font-highway text-4xl md:text-6xl text-sunset mb-6 leading-tight">
            Journey Through
            <span className="block text-route66-orange text-vintage">Your Day</span>
          </h1>
          
          <p className="font-americana text-xl md:text-2xl text-foreground mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Link to="/auth">
              <Button variant="route66" size="lg" className="font-americana text-lg">
                Start Your Journey
              </Button>
            </Link>
            <Link to="/auth">
              <Button variant="desert" size="lg" className="font-americana text-lg">
                Sign In
              </Button>
            </Link>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="vintage-card text-center">
            ...
            <h3 className="font-highway text-lg text-sunset mb-3">
              Road Map View
            </h3>
          ...
          <div className="vintage-card text-center">
            ...
            <h3 className="font-highway text-lg text-route66-orange mb-3">
              Goal Tracking
            </h3>
            <p className="font-americana text-muted-foreground">
        ...
        <div className="text-center mt-16">
          <div className="vintage-card max-w-2xl mx-auto p-8">
            ...
            <h2 className="font-highway text-2xl text-sunset mb-4">
              Ready to Hit the Road?
            </h2>
            <p className="font-americana text-lg text-foreground mb-6">
